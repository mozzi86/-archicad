...
- [ ] **Phase 1: Skill-Gerüst + Safety** — Verzeichnisstruktur, SKILL.md mit allen Safety-Rules, 4 Reference-Skeletons, ohne Live-Archicad
- [ ] **Phase 2: Warm-up live + Story/Attribute-Listing** — MCP-Tool-Namen für alle 7 Warm-up-Felder live verifizieren; STORY-01 + ATTR-01 implementieren
