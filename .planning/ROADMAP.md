...
**Backlog (post-v1.0):**
- [x] **Phase 9 / v1.1 — DWG-zu-BIM-Pipeline** — GELIEFERT 2026-07-13/14, weit über Plan: konturen-zu-waende (4.755+), decken-und-durchbrueche, oeffnungen-aus-konturen, tueren-aus-boegen, treppen-aus-stufenlinien + ELM_SAB v0.3–v0.5 statt AmpliFY-Wrapper. ✅ 2026-07-14
...
- [x] **Phase 5: Bulk-Operations live + Klassifikations-Infrastruktur** — abgeschlossen 2026-07-14: alle TODO-Punkte im 4.500-Wände-Produktivlauf beantwortet (bulk-operations.md § Phase-5-Abschluss), CAP-03/04 aufgelöst, CLASS-Worked-Examples in wall-operations/openings/slabs-columns-beams/zones nachgezogen (library-objects → Phase 8, kein Live-Fall). ✅ 2026-07-14
- [x] **Phase 6: Recipes Reihe 3 — 2D + Materials** — Schema-only 2026-05-20; **live-validiert 2026-07-14 im Produktivbetrieb**: CreatePolylines (271 Umgebungslinien), Stift-/RGB-Arbeit (ELM_SAB SetPen, 50k Overrides am 13.07.), Get2DGeometryOfElements als Linien-Lesepfad, BuildingMaterial-GUID-Zuweisung (Normalglas an 334 Wände). ✅ 2026-07-14
- [x] **Phase 7: Cross-Recipe Integrationstests** — INT-01 ✅ 2026-07-14 (Wand mit BuildingMaterial → CreateWindows punktgenau [Offset+Brüstung exakt, ID-Threading] → Polyline → Rücklese → Cleanup); INT-02 ✅ 2026-07-14 in Produktion (4.500 Wände + 308 Türen + 632 Zonen klassifiziert, THN). Befund: CreateWindows in geraden Wänden präzise → Fenster-Massenlauf via Türwand-Pattern. ✅ 2026-07-14
- [x] **Phase 8: Smoke-Test + Gap-Close** — alle 38 VERIFY-Marker abgearbeitet (2026-07-14): 24 mit Live-Beweis aufgelöst (inkl. 3 Doku-KORREKTUREN: dev_-Präfix bei Klassifikations-Tools, get2_d-Schreibweise, Beam-Details ohne Querschnitt), 14 ehrlich präzisiert stehen gelassen (10× CurtainWall: 0 Testobjekte im Projekt; Beam/Column/Object-UPDATE + GDL-Schreiben: nie ausgeführt). library-objects-Worked-Example ergänzt (596 Objekte, Brandschott/Möbel). ✅ 2026-07-14
