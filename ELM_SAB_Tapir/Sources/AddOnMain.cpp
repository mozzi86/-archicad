...
// ELM_SAB-Befehle (Namespace "ELM_SAB")
...
GSErrCode Initialize (void)
{
    ...
    { // ELM_SAB Commands (Namespace "ELM_SAB")
        ...
        err |= RegisterCommand<GetPenOfElementsCommand> (
            elmSabCommands, "0.9.0",
            "ELM_SAB: Liest Stifte inkl. RGB-Overrides von 2D-Elementen."
        );
        err |= RegisterCommand<CreatePolygonWallsCommand> (
            elmSabCommands, "0.9.0",
            "ELM_SAB: Erstellt Polygonwaende (APIWtyp_Poly) aus Konturen."
        );
        ...
        err |= RegisterCommand<GetTextsCommand> (
            elmSabCommands, "0.9.0",
            "ELM_SAB: Liest Inhalt, Groesse und Position von Texten und Text-Labels."
        );
        err |= RegisterCommand<ELMCreateRoofsCommand> (
            elmSabCommands, "0.9.0",
            "ELM_SAB: Erstellt ebene Daecher (PlaneRoof) mit Pivotlinie und Neigung."
        );
        ...
        err |= RegisterCommand<SetStoryVisibilityOfElementsCommand> (
            elmSabCommands, "0.9.15",
            "ELM_SAB: Setzt 'Auf Geschossen zeigen' von Objekten/Lampen (Preset oder custom), mit Ruecklese und Teamwork-Reservierung."
        );
